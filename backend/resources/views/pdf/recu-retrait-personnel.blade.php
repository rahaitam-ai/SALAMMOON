...
<head>
    <meta charset="utf-8">
    <title>Reçu de Retrait Personnel - {{ $client->nom }} {{ $client->prenom }}</title>
    <style>
        @page {
            size: A4;
            margin: 10mm;
...
<body>
        ...
        <table class="header-table" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="header-right">
                    <div class="title-fr">Reçu de Retrait Personnel</div>
    ...
    <div class="certification">
        Ce document atteste que le titulaire du compte mentionné ci-dessous a effectué un retrait personnel du montant indiqué. Ce reçu est délivré à la demande du client pour servir et valoir ce que de droit.
    </div>
    ...
    <div class="content">
        ...
        <div class="balance-box">
            <div class="balance-label">Montant Retiré</div>
            <div class="balance-value">{{ number_format($retrait->montant, 2, ',', ' ') }} MAD</div>
        </div>

        <div class="details-row">
            <div class="detail-card">
                <div class="detail-title">Type de retrait</div>
                <div class="detail-value">Retrait Personnel</div>
            </div>
            <div class="detail-card">
                <div class="detail-title">Date d'opération</div>
        ...
        <table class="footer-table" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="footer-right">
                    <span class="footer-brand">Reçu de Retrait Personnel</span>
                </td>
            </tr>
        </table>
    </div>
