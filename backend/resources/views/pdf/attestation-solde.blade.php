...
<head>
    <meta charset="utf-8">
    <title>Attestation de Solde - {{ $client->nom }} {{ $client->prenom }}</title>
    <style>
        @page {
            size: A4;
            margin: 10mm;
...
<body>
        ...
        <table class="header-table" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="header-right">
                    <div class="title-fr">Attestation de Solde</div>
    ...
    <div class="certification">
        Nous attestons par la présente que le titulaire du compte mentionné ci-dessus dispose, à la date de génération de ce document, d'un solde créditeur correspondant au montant indiqué dans cette attestation.
        Cette attestation est délivrée à la demande du client pour servir et valoir ce que de droit.
    </div>
    ...
    <div class="content">
        ...
        <div class="balance-box">
            ...
            <div class="balance-value">{{ number_format($account->balance, 2, ',', ' ') }} MAD</div>
        </div>
        ...
        <div class="details-row">
            ...
            <div class="detail-card">
                <div class="detail-title">Date d'émission</div>
                <div class="detail-value">{{ $issueDate }}</div>
            </div>
            <div class="detail-card">
                <div class="detail-title">Heure d'émission</div>
        ...
        <table class="footer-table" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="footer-right">
                    <span class="footer-brand">Attestation de Solde</span>
                </td>
            </tr>
        </table>
    </div>
